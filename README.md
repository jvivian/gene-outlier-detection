...
See [Model Explanation](#model-explanation) for more information or the [preprint](https://www.biorxiv.org/content/early/2019/06/06/662338.full.pdf_).
...
- `--background`
    - A path to the matrix that contains the background datasets and at least one column at the beginning used to as the label vector for differnet groups in the background.
- `--name`
